...
const LOCATIONS = [
  ...
  { code: 'WH1', name: 'Warehouse 1', slug: 'warehouse-1', lat: -1.9722, lng: 30.1389, order: 3 },
  { code: 'WH2', name: 'Warehouse 2', slug: 'warehouse-2', lat: -1.9729, lng: 30.1399, order: 4 },
  { code: 'WH3', name: 'Warehouse 3', slug: 'warehouse-3', lat: -1.9731, lng: 30.1387, order: 5 },
  { code: 'WH4', name: 'Warehouse 4', slug: 'warehouse-4', lat: -1.9733, lng: 30.1392, order: 6 },
  { code: 'WH5', name: 'Warehouse 5', slug: 'warehouse-5', lat: -1.9735, lng: 30.1397, order: 7 },
  { code: 'WH6', name: 'Warehouse 6', slug: 'warehouse-6', lat: -1.9737, lng: 30.1402, order: 8 },
  { code: 'WH7', name: 'Warehouse 7', slug: 'warehouse-7', lat: -1.9739, lng: 30.1407, order: 9 },
  { code: 'COLD', name: 'Cold Room', slug: 'cold-room', lat: -1.9725, lng: 30.1404, order: 10 },
  { code: 'LOAD', name: 'Loading Bay', slug: 'loading-bay', lat: -1.9718, lng: 30.1378, order: 11 },
  { code: 'PARK', name: 'Parking', slug: 'parking', lat: -1.9701, lng: 30.1382, order: 12 },
  { code: 'FUEL', name: 'Fuel Station', slug: 'fuel-station', lat: -1.9695, lng: 30.1401, order: 13 },
  { code: 'YARD', name: 'Container Yard', slug: 'container-yard', lat: -1.9736, lng: 30.1412, order: 14 },
  { code: 'CUST', name: 'Customs Area', slug: 'customs', lat: -1.9710, lng: 30.1420, order: 15 },
  { code: 'ROAD', name: 'Main Road', slug: 'main-road', lat: -1.9698, lng: 30.1370, order: 16 },
  { code: 'OFF', name: 'Office Block', slug: 'office-block', lat: -1.9704, lng: 30.1415, order: 17 },
  { code: 'OTHER', name: 'Other', slug: 'other', lat: -1.9715, lng: 30.1395, order: 18 },
];
...
async function seed() {
  ...
  const sampleReports = [
    ...
    },
    {
      ...
      desc: 'Pallet stack in Warehouse 1 leaned during pick. Operator stepped back; stack settled without collapse.',
      lat: -1.9722,
      lng: 30.1389,
      name: 'Diane Mukamana',
    ...
    },
    {
      ...
      loc: 'WH2',
      status: 'open',
      desc: 'Forklift travelling with elevated load near pedestrian walkway in Warehouse 2.',
      lat: -1.9729,
      lng: 30.1399,
      name: 'Hassan Mwangi',
